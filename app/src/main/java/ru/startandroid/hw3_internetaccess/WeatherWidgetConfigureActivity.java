...
public class WeatherWidgetConfigureActivity extends Activity {
    ...
    private static final String PREFS_NAME = "ru.startandroid.hw3_internetaccess.WeatherWidget";
    ...
    public void onCreate(Bundle icicle) {
        ...
        mAppWidgetText = (EditText)findViewById(R.id.city_text);
